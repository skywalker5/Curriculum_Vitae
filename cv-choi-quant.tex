...
%	\fancyhead{} %clear out default
	\begin{rSection}{Research Interest}
		Knowledge Graph Completion, Natural Language Processing, Machine Learning Methods\hfill
		\vspace{-2mm}
	\end{rSection}
...
%		\vspace{1mm}	
\begin{rSubsection}{Intelliquant }{Jun 2019 - Jun 2019}{Advisory Researcher}{Intelliquant.}
	\vspace*{-1mm}
	\item Advised machine-learning model development for the quantitative trading platform \href{https://intelliquant.co.kr/}{Intelliquant}.
	\item Designed a short-term multi-factor model using machine learning models.
\end{rSubsection}	
\vspace*{-2.5mm}
